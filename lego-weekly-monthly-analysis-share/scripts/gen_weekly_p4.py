...
with open('/Users/a123/WorkBuddy/Claw/outputs/weekly_analysis.html', 'a', encoding='utf-8') as f:
    f.write(_html_out)

import os
sz = os.path.getsize('/Users/a123/WorkBuddy/Claw/outputs/weekly_analysis.html')
