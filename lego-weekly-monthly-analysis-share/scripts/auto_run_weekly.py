...
# 固定配置
# ============================================================
PROJECT_DIR = '/Users/a123/WorkBuddy/Claw'
...
const fs = require('fs');
const files = [
  ['/Users/a123/WorkBuddy/Claw/outputs/weekly_analysis.html', 'weekly'],
  ['/Users/a123/WorkBuddy/Claw/outputs/monthly_analysis.html', 'monthly']
];
let hasError = false;
